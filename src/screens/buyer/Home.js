...
import {
  getProductsVegetable,
  getProductsFruit,
} from '../../public/redux/actions/product';
...
const HomeScreen = ({
  getProductsVegetable,
  getProductsFruit,
  product: {productsFruit, productsVegetable},
  navigation,
}) => {
  useEffect(() => {
    const getFruit = async () => {
      try {
        const response = await axios.get(
          'http://34.202.135.29:4000/api/v1/products?limit=4&category_id=2',
        );
    ...
    const getVegetable = async () => {
      try {
        const response = await axios.get(
          'http://34.202.135.29:4000/api/v1/products?limit=4&category_id=1',
        );
